...
\begin{enumerate}
\item Bagaimana cara memastikan data stok di gudang barang jadi selalu akurat dan terintegrasi secara \textit{real-time} di seluruh tingkatan sistem?
\item Bagaimana merancang sistem perpindahan barang otomatis menggunakan \textit{mobile robot} untuk meningkatkan kecepatan proses dan meminimalkan kesalahan operasional?
\item Bagaimana mengelola serta mengoordinasikan armada robot secara aman dan terpusat agar tugas pemindahan barang berjalan efektif serta mudah ditingkatkan kapasitasnya sesuai kebutuhan?
\end{enumerate}
...
\begin{enumerate}
\item Mengembangkan layanan \textit{backend} berupa \textit{Warehouse Management Controller} (WMC) yang mampu menjamin konsistensi data stok antara kondisi fisik di gudang dengan catatan digital secara otomatis dan terintegrasi.
\item Mengembangkan mekanisme pelacakan operasional gudang secara digital yang mampu mendokumentasikan setiap pergerakan barang dari proses penerimaan hingga distribusi secara menyeluruh.
\end{enumerate}
